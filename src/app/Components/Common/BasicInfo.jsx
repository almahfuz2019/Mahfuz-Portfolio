...
export default function BasicInfo() {
  return (
    <div className="flex  justify-center items-center lg:mt-0 md:mt-80 mt-40">
      <div className="bg-white   rounded-lg px-6  shadow-lg lg:w-auto  md:w-[90vw]">
        <div className="relative ">
          <Image
            src="/Images/Abdullah_al_mahfuz.png"
            alt="Profile Picture"
            className="w-full md:w-auto lg:w-full mx-auto  object-cover rounded-lg -mt-[50%] shadow-2xl"
            width={500}
            height={500}
          />
        </div>
        <div className="py-6 text-center ">
          ...
          <div className="flex justify-center space-x-4 my-4">
            ...
            <a
              href="#"
              className="text-[#1C9CEA] bg-secondary p-2 rounded-lg transition duration-300 ease-in-out hover:text-white hover:bg-primary transform hover:scale-110"
            >
              <FaTwitter className="text-xl leading-[20px]" />
            </a>
            <a
              href="#"
              className="text-[#E12A7A] bg-secondary p-2 rounded-lg transition duration-300 ease-in-out hover:text-white hover:bg-primary transform hover:scale-110"
            >
          ...
          <div className="space-y-3 mt-8 bg-secondary p-6 rounded-lg">
            ...
            <div className="flex items-center space-x-2 pb-3 hover:bg-gray-100">
              ...
              <div className="text-base justify-start items-start flex flex-col">
                <p className="text-xs text-accent">Birthday</p>
                <p>April 21, 2000</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <button
              className="mt-6 font-medium  text-lg leading-[27px] bg-primary rounded-lg text-white px-[30px] py-[14px] flex justify-center items-center gap-x-2 transition duration-300 ease-in-out transform hover:bg-primary-dark hover:scale-105 hover:shadow-lg"
