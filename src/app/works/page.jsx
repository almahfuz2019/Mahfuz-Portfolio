  ...
  return (
    <div className="rounded-xl bg-white w-full p-6">
      ...
      <div className="flex mt-10 gap-x-4 justify-start items-center">
        <h1 className="text-[42px] font-bold leading-[60px]">Portfolio</h1>
        ...
        <TabPanel>
          <div className="grid grid-cols-2 gap-6">
            <div className="relative group p-4 bg-[#F5F5F5] rounded-lg transition-transform transform hover:shadow">
              ...
              <a
                href="#"
                className=" cursor-pointer text-lg font-medium group-hover:text-blue-500"
              >
                Chul Urina
              </a>
              <p className="mt-1 text-base font-normal group-hover:text-gray-700">
                Travel Landing, UX/UI
              </p>
              <div className="flex flex-wrap gap-3 justify-start items-start pt-4 pb-2">
                <span className="inline-block bg-gray-200 border border-primary border-opacity-10 rounded-full px-3 py-1 text-xs font-semibold text-gray-700 ">
                  #React
                </span>
                <span className="inline-block bg-gray-200 border border-primary border-opacity-10 rounded-full px-3 py-1 text-xs font-semibold text-gray-700 ">
                  #TailwindCSS
